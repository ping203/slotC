...
cc.game.onStart = function(){
    ...
    if(cc.sys.isNative){
        ...
        // window.innerWidth
        // window.innerHeight
        cc.view.setDesignResolutionSize(window.innerWidth, window.innerHeight, cc.ResolutionPolicy.FIXED_HEIGHT);
