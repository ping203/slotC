 ...
 */
var baseUrlSoundVQV = "res/DeCheThanhRome/Sound/";
DeCheThanhRomeAudio = cc.Class.extend(
    {
        ...
        baoKetQua: baseUrlSoundVQV + "Bao_ket_qua.mp3",
        button: baseUrlSoundVQV +"button.mp3",
        banTen: baseUrlSoundVQV +"Banten.mp3",
        binhVo: baseUrlSoundVQV +"Binhvo.mp3",
        ...
        {
            if(this.isOnSoundEffect && deCheThanhRomeAppear)
            {
