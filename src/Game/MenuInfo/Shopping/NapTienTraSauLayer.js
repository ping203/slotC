...
var NapTienTraSauLayer = BaseLayer.extend({
    ...
    createPnNapTienTraTruoc: function () {
        ...
        this.addButton(this.pn_nap_tien_tra_truoc, "btn_nttt_select_loaithe", NapTienTraSauLayer.BTN_SELECT_NHAMANG_NTTT, cc.p(241.5, 312.5), true, res_ResourceMenuTab_BaoMat + '/bt2.png', res_ResourceMenuTab_BaoMat + '/bt2.png');
        ...
        this.addButton(this.pn_nap_tien_tra_truoc, "btn_dau_so_nttt", NapTienTraSauLayer.BTN_SELECT_DAUSO_NTTT, cc.p(115, 249), true, res_ResourceMenuTab_BaoMat + '/bt2.png', res_ResourceMenuTab_BaoMat + '/bt2.png');
        ...
        this.addButton(this.pn_nap_tien_tra_truoc, "btn_clear_fone", NapTienTraSauLayer.BTN_CLEAR_FONE, cc.p(437.5, 247), true, res_ResourceMenuTab_BaoMat + "/closetf.png", res_ResourceMenuTab_BaoMat + "/closetf.png");
        ...
        this.addButton(this.pn_nap_tien_tra_truoc, "btn_chon_muc_nap_dt", NapTienTraSauLayer.BTN_OPEN_MENHGIA_NAP_DT, cc.p(240, 182), true, res_ResourceMenuTab_BaoMat + '/bt2.png', res_ResourceMenuTab_BaoMat + '/bt2.png');
        ...
        this.addButtonStructure(this.pn_nap_tien_tra_truoc, "btn_tiep_tuc_nttt", NapTienTraSauLayer.BTN_TIEPTUC_NTTT, cc.p(240, 43), true,
        ...
        this.addButton(this.pn_menhgia_nap_dt, "btn_close_menhgia_nap_dt", NapTienTraSauLayer.BTN_CLOSE_MENHGIA_NAP_DT, cc.p(344, 342), true, res_ResourceMenuTab_BaoMat + '/bt2.png', res_ResourceMenuTab_BaoMat + '/bt2.png');
    ...
    createPnDauSoMobi: function () {
        ...
        this.addButton(this.pn_dau_so_mobi, "btn_close_dau_so_mobi", NapTienTraSauLayer.BTN_CLOSE_DAUSO_MOBI, cc.p(454, 292), true, res_ResourceMenuTab_BaoMat + "/bt2.png", res_ResourceMenuTab_BaoMat + "/bt2.png");
    ...
    loadNhaMang: function (str) {
        ...
        var arrNhamang = [];
        for (var i = 0; i < array.length; i++) {
            var itemNhamang = NapTienTraSauLayer.arrInfoButtonSelectNhaMang[array[i]];
    ...
    createPnNhaMang: function (arr) {
        ...
        this.addButton(this.pn_nha_mang, "btn_close_select_mua_the_dt", NapTienTraSauLayer.BTN_CLOSE_SELECT_MUA_THE_DT, cc.p(447.5, 130), true, res_ResourceMenuTab_BaoMat + "/bt2.png", res_ResourceMenuTab_BaoMat + "/bt2.png");
    ...
    changeButtonNhaMang: function (kind, arr) {
        ...
        if (kind == 0) {
            ...
            for (var i = 0; i < array.length; i++) {
                this[NapTienTraSauLayer.arrInfoButtonSelectNhaMang[array[i]].nameButton].setTitleText(NapTienTraSauLayer.arrInfoButtonSelectNhaMang[array[i]].txtBt);
            }

        } else {
            for (var i = 0; i < array.length; i++) {
                this[NapTienTraSauLayer.arrInfoButtonSelectNhaMang[array[i]].nameButton].setTitleText(NapTienTraSauLayer.arrInfoButtonSelectNhaMang[array[i]].txtNT);
            }
        }
    },
    ...
    onButtonRelease: function (button, id) {
        switch (id) {
            case NapTienTraSauLayer.BTN_SELECT_NHAMANG_NTTT:
                this.pn_nha_mang.setVisible(true);
                this.pn_nha_mang.runAction(cc.scaleTo(0.15, 1, 1));
                break;
            case NapTienTraSauLayer.BTN_SELECT_DAUSO_NTTT:
                this.pn_dau_so_mobi.setVisible(true);
                this.pn_dau_so_mobi.runAction(cc.scaleTo(0.15, 1, 1));
                break;
            case NapTienTraSauLayer.BTN_CLOSE_DAUSO_MOBI:
                this.pn_dau_so_mobi.runAction(cc.scaleTo(0.15, 1, 0));
                this.pn_dau_so_mobi.setVisible(false);
                break;
            case NapTienTraSauLayer.BTN_CLOSE_SELECT_MUA_THE_DT:
                this.pn_nha_mang.runAction(cc.scaleTo(0.15, 1, 0));
                this.pn_nha_mang.setVisible(false);
                break;
            case NapTienTraSauLayer.BTN_MUATHEDT_VINA:
                ...
                this.pn_nha_mang.setVisible(false);
                break;
            case NapTienTraSauLayer.BTN_MUATHEDT_MOBI:
                ...
                this.pn_nha_mang.setVisible(false);
                break;
            case NapTienTraSauLayer.BTN_MUATHEDT_VIETTEL:
                ...
                this.pn_nha_mang.setVisible(false);
                break;
            case NapTienTraSauLayer.BTN_MUATHEDT_VNMOBILE:
                ...
                this.pn_nha_mang.setVisible(false);
                break;
            case NapTienTraSauLayer.BTN_MUATHEDT_BEELINE:
                ...
                this.pn_nha_mang.setVisible(false);
                break;
            case NapTienTraSauLayer.BTN_CLOSE_MENHGIA_NAP_DT:
                this.pn_menhgia_nap_dt.runAction(cc.scaleTo(0.15, 1, 0));
                this.pn_menhgia_nap_dt.setVisible(false);
                break;
            case NapTienTraSauLayer.BTN_OPEN_MENHGIA_NAP_DT:
                this.pn_menhgia_nap_dt.setVisible(true);
                this.pn_menhgia_nap_dt.runAction(cc.scaleTo(0.15, 1, 1));
                break;

            case NapTienTraSauLayer.BTN_CLEAR_FONE:
                this.tf_phone_number_nttt.setString("");
                this.tf_phone_number_nttt.setPlaceHolder("Nhập số điện thoại");
                this.btn_clear_fone.setVisible(false);
                this.tf_phone_number_nttt.setColor(GuiUtil.color("#FFFFFF"));
                this.tf_phone_number_nttt.runAction(cc.scaleTo(0.225, 1));
                break;
            case NapTienTraSauLayer.BTN_TIEPTUC_NTTT:
...
NapTienTraSauLayer.BTN_SELECT_NHAMANG_NTTT = 1;
NapTienTraSauLayer.BTN_SELECT_DAUSO_NTTT = 2;
NapTienTraSauLayer.BTN_CLOSE_DAUSO_MOBI = 3;
NapTienTraSauLayer.BTN_CLOSE_SELECT_MUA_THE_DT = 4;
NapTienTraSauLayer.BTN_MUATHEDT_VINA = 5;
NapTienTraSauLayer.BTN_MUATHEDT_MOBI = 6;
NapTienTraSauLayer.BTN_MUATHEDT_VIETTEL = 7;
NapTienTraSauLayer.BTN_MUATHEDT_VNMOBILE = 8;
NapTienTraSauLayer.BTN_MUATHEDT_BEELINE = 9;
NapTienTraSauLayer.BTN_CLOSE_MENHGIA_NAP_DT = 10;
NapTienTraSauLayer.BTN_OPEN_MENHGIA_NAP_DT = 11;
NapTienTraSauLayer.BTN_CLEAR_FONE = 12;
NapTienTraSauLayer.BTN_TIEPTUC_NTTT = 13


NapTienTraSauLayer.arrInfoButtonSelectNhaMang = [
    {
        tagButton: NapTienTraSauLayer.BTN_MUATHEDT_VIETTEL,
    ...
    {
        tagButton: NapTienTraSauLayer.BTN_MUATHEDT_VINA,
    ...
    {
        tagButton: NapTienTraSauLayer.BTN_MUATHEDT_MOBI,
    ...
    {
        tagButton: NapTienTraSauLayer.BTN_MUATHEDT_VNMOBILE,
    ...
    {
        tagButton: NapTienTraSauLayer.BTN_MUATHEDT_BEELINE,
